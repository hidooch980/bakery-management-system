...
> **انتقال انجام شد.** سرور اصلی حالا `194.5.176.140` است و `server.json`
> دیگر سرور قدیمی را به‌عنوان جایگزین معرفی نمی‌کند. `185.97.119.91` فقط
> تا وقتی روشن می‌ماند که از سالم‌بودن انتقال مطمئن شویم، و **نباید روی آن
> چیزی ثبت شود** — هرچه آنجا ثبت شود در سرور اصلی نیست.
>
> بقیهٔ این سند برای انتقال بعدی نگه داشته شده است.

سرور مبدأ `185.97.119.91` بود و مقصد `194.5.176.140`. این سند ترتیبی را
