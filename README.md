...
**سهمیه ماهانه** به‌صورت خودکار بین سه دوره تقسیم می‌شود، و باقیمانده گرد کردن به دوره آخر می‌رود تا جمع اجزا همیشه برابر کل باشد:
...
│   ├── routes/api.php            # ۶۹ مسیر نقش‌محور
│   └── tests/Feature/            # ۶۹ تست
│
├── mobile-app/                   # Flutter
│   ├── lib/
