...
| 🏦 وام‌ها | اصل، قسط و سررسید؛ مانده از روی پرداخت‌ها شمرده می‌شود و سررسید نزدیک یا عقب‌افتاده هشدار می‌دهد |
| 🛡️ مرکز خطاها | ۱۴ بررسی روی داده‌های خود سامانه — موجودی منفی، مصرف بیش از سهمیه، حساب تسویه‌نشده، قسط عقب‌افتاده. هر مورد قابل «پاسخ دادن» است و اگر بزرگ‌تر شود خودش برمی‌گردد |
