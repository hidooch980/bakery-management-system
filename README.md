...
| 🗓️ تعطیلات | ثبت روزهای تعطیل؛ در گزارش حضور، غیبت محسوب نمی‌شوند |
| 📅 سهمیه آرد | تقسیم خودکار سهمیه ماهانه بین سه دوره (۵–۱۴، ۱۵–۲۴، ۲۵ تا ۴ ماه بعد) |
...
| **فروشنده** (`seller`) | مشاهده چانه‌های آماده، ثبت فروش با تعداد نان و مشتری، فروش‌های امروز، تیک حضور، تغییر رمز، خروج |
...
│   ├── routes/api.php            # ۷۶ مسیر نقش‌محور
│   └── tests/Feature/            # ۱۰۳ تست
│
├── mobile-app/                   # Flutter
│   ├── lib/
