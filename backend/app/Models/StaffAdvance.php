...
class StaffAdvance extends Model
{
    ...
    public function bankPostingAccountId(): ?int
    {
        ...
        //
        // تا دیروز خالی اصلاً هیچ حسابی را سبک نمی‌کرد: پول بیرون می‌رفت
        // و دفتر همچنان آن را داشت. آن درست شد، ولی با حدسِ غلط — فرمِ
        // پنل نوشته بود «خالی بگذارید اگر از صندوق پرداخت شده» و همان را
        // باور کردم. مالک گفت مساعده از حساب سفید می‌رود نه از صندوق، و
        // او می‌داند پول از کجا بیرون می‌رود.
        //
        // متنِ فرم هم با همین عوض شد: جمله‌ای که خودش باعثِ حدسِ غلط بوده
        // اگر سر جایش بماند، نفر بعدی را هم همان‌جا می‌برد.
