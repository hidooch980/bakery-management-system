...
<body>
    ...
    <footer class="wrap">
        ...
        {{-- در جدا، و کوچک. این صفحه مالِ مشتریِ نان است؛ نانوایی‌ای
             که دنبال سامانه می‌گردد مهمانِ پایینِ صفحه است، نه چیزی
             که جلوی چشمِ کسی بیاید که فقط آمده ببیند تنور کِی روشن
             است. --}}
        <br>
        <a href="{{ route('signup') }}">نانوایی دارید؟ این سامانه را بگیرید</a>
    </footer>
</body>
</html>
